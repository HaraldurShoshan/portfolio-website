...
export default function Project({
	...
	return (
        ...
        overflow-hidden rounded-lg sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8
		dark:bg-white/10 dark:hover:bg-white/20 dark:text-white"
            ...
            sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]"
				>
					...
					<a href={url} target="_blank" className="text-lg my-2 underline">
						{displayUrl}
					</a>
